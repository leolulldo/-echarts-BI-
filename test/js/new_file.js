	    ...
	    series: [
	        {
	           ...
	           label: {
	            ...
	            data:[
	                {value:556, name:'可信'},
	                {value:100, name:'不可信',selected:true},
	                {value:30, name:'未知'}
	            ]
...
function barChar(data){
	barChart= echarts.init(document.getElementById("bar-chart"));
	 option = {
	    ...
	    xAxis: {
	        data: ["WDR-5600","WDR-5720","CPE-600"],       //横坐标
	        axisLabel:{
	            textStyle: {
	                color:'#fff',
	                 fontSize:12,
...
function barschar(){
     ...
     option = {
	    ...
	    yAxis: {
	        data: ['2020.7', '2020.8', '2020.9', '2020.10', '2020.11'],
	        axisLabel: {
		            textStyle: {
		                color: '#fff',
		                 fontSize:12,//坐标值得具体的颜色
...
function progress1char(){
	pieChart= echarts.init(document.getElementById("progress1-chart"));
	option = {
		color:["#4f8bf9","#fea31e","#959595"],
	    tooltip: {
	        trigger: 'item',
	    ...
	    series: [
	        {
	           ...
	           label: {
	            ...
	            data:[
	                {value:126, name:'可信'},
	                {value:118, name:'不可信',selected:true},
	                {value:30, name:'未知'}
	            ]
	        }
	    ]
...
function progress2char(){
	progress1chart = echarts.init(document.getElementById("progress2-chart"));
	var baifenbi = [0.333, 0.444, 0.555, 0.777, 0.888];
	var grayBar = [1, 1, 1, 1, 1, ];
	var paiming = [ 5, 4, 3, 2, 1];
	var xingm = ['CPE-600', 'WDR-5720', 'CPE-600', 'WDR-5720', 'WDR-5720'];
	option = {
	    title: {
	        text: '2020年 第三季度',
	        left: '75%',
